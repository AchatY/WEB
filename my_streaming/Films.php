...
i></ul>";
  ...
  <body>
    <div class="bloc_page">
      ...
      <div id = 'Films'>
      <p id = 'titre_films_attendu'>Films</p>
      <div id='best_seller'>
        <?php display_news_banner(); ?>
      </div>
    </div>
    <div id = 'Genre_Films'>
        <p id = 'titre_films_attendu'>Genre de Films</p>
        <ul>
          <li><a href = 'produits.php?categorie=Action&console=Films'>Action</a></li>
          <li><a href = 'produits.php?categorie=Aventure&console=Films'>Aventure</a></li>
          <li><a href = 'produits.php?categorie=Comedie&console=Films'>Comedie</a></li>
          <li><a href = 'produits.php?categorie=Drame&console=Films'>Drame</a></li>
          <li><a href = 'produits.php?categorie=Animation&console=Films'>Animation</a></li>
          <li><a href = 'produits.php?categorie=Arts_Martiaux&console=Films'>Arts_Martiaux</a></li>
          <li><a href = 'produits.php?categorie=Thriller&console=Films'>Thriller</a></li>
          <li><a href = 'produits.php?categorie=Biopic&console=Films'>Biopic</a></li>
          <li><a href = 'produits.php?categorie=Policier&console=Films'>Policier</a></li>
          <li><a href = 'produits.php?categorie=Romance&console=Films'>Romance</a></li>
          <li><a href = 'produits.php?categorie=Comedie_drame&console=Films'>Comedie_drame</a></li>
          <li><a href = 'produits.php?categorie=Western&console=Films'>Western</a></li>
          <li><a href = 'produits.php?categorie=Fantastique&console=Films'>Fantastique</a></li>
          <li><a href = 'produits.php?categorie=Guerre&console=Films'>Guerre</a></li>
         </ul>
    </div>
    </div>
    </div>
