...
{
  $connexion = connect_to_db();
  $requete = "SELECT count(Produit_Utilisateur.ID_produit) AS NB                            
  FROM Produits                                                                             
...
<html>
  ...
  <body>
	...
	<form action="produits.php" method="get">
	  <input type="submit" name="categorie" id = "Playstation" value = "Play Station"/>
	  <input type="submit" name="categorie" id = "Xbox" value = "XBOX"/>
	  <input type="submit" name="categorie" id = "Wii" value = "WII"/>
	  <input type="submit" name="categorie" id = "PC" value = "PC"/>
